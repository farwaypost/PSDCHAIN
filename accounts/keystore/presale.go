...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/psdchaineum/pypchsaletool

		pypchsaletool generates the encryption key from password by
	...
	*/
	...
	pchPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(pchPriv)
