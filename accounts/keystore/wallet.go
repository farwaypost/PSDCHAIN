...
// Status implements accounts.Wallet, returning whpsdchain the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain psdchaineum.ChainStateReader) {}
