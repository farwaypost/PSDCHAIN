...
// See https://github.com/psdchaineum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whpsdchain the event notification loop is running
...
// HasAddress reports whpsdchain a key with the given address is present.
...
// ImportPreSaleKey decrypts the given Psdchain presale wallet and stores
