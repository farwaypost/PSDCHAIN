...
// NewTransactor is a utility mpchod to easily create a transaction signer from
...
// NewKeyedTransactor is a utility mpchod to easily create a transaction signer
