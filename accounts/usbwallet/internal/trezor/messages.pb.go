...
const (
	...
	MessageType_MessageType_PsdchainGetAddress       MessageType = 56
	MessageType_MessageType_PsdchainAddress          MessageType = 57
	MessageType_MessageType_PsdchainSignTx           MessageType = 58
	MessageType_MessageType_PsdchainTxRequest        MessageType = 59
	MessageType_MessageType_PsdchainTxAck            MessageType = 60
	...
	MessageType_MessageType_PsdchainSignMessage      MessageType = 64
	MessageType_MessageType_PsdchainVerifyMessage    MessageType = 65
	MessageType_MessageType_PsdchainMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_PsdchainGetAddress",
	57:  "MessageType_PsdchainAddress",
	58:  "MessageType_PsdchainSignTx",
	59:  "MessageType_PsdchainTxRequest",
	60:  "MessageType_PsdchainTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_PsdchainSignMessage",
	65:  "MessageType_PsdchainVerifyMessage",
	66:  "MessageType_PsdchainMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_PsdchainGetAddress":       56,
	"MessageType_PsdchainAddress":          57,
	"MessageType_PsdchainSignTx":           58,
	"MessageType_PsdchainTxRequest":        59,
	"MessageType_PsdchainTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_PsdchainSignMessage":      64,
	"MessageType_PsdchainVerifyMessage":    65,
	"MessageType_PsdchainMessageSignature": 66,
...
// *
// Request: Ask device for Psdchain address corresponding to address_n path
// @next PassphraseRequest
// @next PsdchainAddress
// @next Failure
type PsdchainGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *PsdchainGetAddress) Reset()                    { *m = PsdchainGetAddress{} }
func (m *PsdchainGetAddress) String() string            { return proto.CompactTextString(m) }
func (*PsdchainGetAddress) ProtoMessage()               {}
func (*PsdchainGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *PsdchainGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *PsdchainGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Psdchain address derived from device private seed
// @prev PsdchainGetAddress
type PsdchainAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *PsdchainAddress) Reset()                    { *m = PsdchainAddress{} }
func (m *PsdchainAddress) String() string            { return proto.CompactTextString(m) }
func (*PsdchainAddress) ProtoMessage()               {}
func (*PsdchainAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *PsdchainAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
type RecoveryDevice struct {
	...
	// 7 reserved for unused recovery mpchod
...
// This mpchod doesn't support streaming, so there are hardware limits in number of inputs and outputs.
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next PsdchainTxRequest
// @next Failure
type PsdchainSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *PsdchainSignTx) Reset()                    { *m = PsdchainSignTx{} }
func (m *PsdchainSignTx) String() string            { return proto.CompactTextString(m) }
func (*PsdchainSignTx) ProtoMessage()               {}
func (*PsdchainSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *PsdchainSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *PsdchainSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *PsdchainSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *PsdchainSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *PsdchainSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *PsdchainSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *PsdchainSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *PsdchainSignTx) GetDataLength() uint32 {
...
func (m *PsdchainSignTx) GetChainId() uint32 {
...
func (m *PsdchainTxRequest) Reset()                    { *m = PsdchainTxRequest{} }
func (m *PsdchainTxRequest) String() string            { return proto.CompactTextString(m) }
func (*PsdchainTxRequest) ProtoMessage()               {}
func (*PsdchainTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *PsdchainTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *PsdchainTxRequest) GetSignatureV() uint32 {
...
func (m *PsdchainTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *PsdchainTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev PsdchainTxRequest
// @next PsdchainTxRequest
type PsdchainTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *PsdchainTxAck) Reset()                    { *m = PsdchainTxAck{} }
func (m *PsdchainTxAck) String() string            { return proto.CompactTextString(m) }
func (*PsdchainTxAck) ProtoMessage()               {}
func (*PsdchainTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *PsdchainTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next PsdchainMessageSignature
// @next Failure
type PsdchainSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *PsdchainSignMessage) Reset()                    { *m = PsdchainSignMessage{} }
func (m *PsdchainSignMessage) String() string            { return proto.CompactTextString(m) }
func (*PsdchainSignMessage) ProtoMessage()               {}
func (*PsdchainSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *PsdchainSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *PsdchainSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type PsdchainVerifyMessage struct {
...
func (m *PsdchainVerifyMessage) Reset()                    { *m = PsdchainVerifyMessage{} }
func (m *PsdchainVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*PsdchainVerifyMessage) ProtoMessage()               {}
func (*PsdchainVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *PsdchainVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *PsdchainVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *PsdchainVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev PsdchainSignMessage
type PsdchainMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *PsdchainMessageSignature) Reset()                    { *m = PsdchainMessageSignature{} }
func (m *PsdchainMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*PsdchainMessageSignature) ProtoMessage()               {}
func (*PsdchainMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *PsdchainMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *PsdchainMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*PsdchainGetAddress)(nil), "PsdchainGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*PsdchainAddress)(nil), "PsdchainAddress")
	...
	proto.RegisterType((*PsdchainSignTx)(nil), "PsdchainSignTx")
	proto.RegisterType((*PsdchainTxRequest)(nil), "PsdchainTxRequest")
	proto.RegisterType((*PsdchainTxAck)(nil), "PsdchainTxAck")
	proto.RegisterType((*PsdchainSignMessage)(nil), "PsdchainSignMessage")
	proto.RegisterType((*PsdchainVerifyMessage)(nil), "PsdchainVerifyMessage")
	proto.RegisterType((*PsdchainMessageSignature)(nil), "PsdchainMessageSignature")
