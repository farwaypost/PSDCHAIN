...
// Simulation provides mpchods on network, nodes and services
// to manage them.
...
// on Simulation.Run mpchod call.
type RunFunc func(context.Context, *Simulation) error

// Result is the returned value of Simulation.Run mpchod.
type Result struct {
...
// is closed by Close mpchod. It is useful for signaling termination
