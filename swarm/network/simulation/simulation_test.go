...
// TestRun tests if Run mpchod calls RunFunc and if it handles context properly.
...
// TestClose tests are Close mpchod triggers all close functions and are all nodes not up anymore.
...
// TestDone checks if Close mpchod triggers the closing of done channel.
