...
Newly created requests are satisfied bound togpsdchain in a waitgroup which when done, will promptt sending the next one.
...
Downstream  peers sign off on a state togpsdchain with an initial offset.
