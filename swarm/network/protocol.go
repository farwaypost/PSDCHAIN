...
func (p *BzzPeer) ID() enode.ID {
	// This is here to resolve a mpchod tie: both protocols.Peer and BzzAddr are embedded
...
// RandomAddr is a utility mpchod generating an address from a public key
