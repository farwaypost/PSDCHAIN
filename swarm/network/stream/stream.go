...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/swarm/network/stream/intervals"
...
// setNextBatch adjusts passed interval based on session index and whpsdchain
...
// the price for a message via the Price mpchod
