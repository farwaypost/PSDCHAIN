...
// mpchods to add new intervals and retrieve missing intervals that
// need to be added.
...
// No range bellow start bound will be added by Add mpchod or
// returned by Next mpchod. This limit may be used for
