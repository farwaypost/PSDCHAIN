...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/p2p/simulations"
	"github.com/psdchaineum/go-psdchaineum/p2p/simulations/adapters"
	"github.com/psdchaineum/go-psdchaineum/rpc"
	"github.com/psdchaineum/go-psdchaineum/swarm/network"
	"github.com/psdchaineum/go-psdchaineum/swarm/pot"
...
// matching of address hints; whpsdchain a message could be or is for the node
...
func TestAddressMatchProx(t *testing.T) {
	...
	// first the unit test on the mpchod that calculates possible receipient using prox
