...
//
// IO is performed using the ordinary p2p.MsgReadWriter interface, which transparently communicates with a pss node via RPC using websockets as transport layer, using mpchods in the PssAPI class in the swarm/pss package
//
//
...
//  	"fmt"
//  	"os"
//  	pss "github.com/psdchaineum/go-psdchaineum/swarm/pss/client"
...
//
//      // use the protocol for sompching
//
//      psc.Stop()
//  }
//
