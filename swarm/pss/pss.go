...
type Pss struct {
	...
	*KeyStore
	...
	fwdCache        map[pssDigest]pssCacheEntry // checksum of unique fields from pssmsg mapped to expiry, cache to determine whpsdchain to drop msg
...
// add API mpchods to the pss API
