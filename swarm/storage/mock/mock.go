...
// GlobalStorer defines mpchods for mock db store
...
// Importer defines mpchod for importing mock store data
// from an exported tar archive.
type Importer interface {
	Import(r io.Reader) (n int, err error)
}

// Exporter defines mpchod for exporting mock store data
// to a tar archive.
