...
import (
	...
	ch "github.com/psdchaineum/go-psdchaineum/swarm/chunk"
...
type JoinerParams struct {
	...
	addr   Address
	getter Getter
	// TODO: there is a bug, so depth can only be 0 today, see: https://github.com/psdchainsphere/go-psdchaineum/issues/344
	depth int
	ctx   context.Context
}
