...
The main type is DB which manages the storage by providing mpchods to
...
that provides adequate mpchod to perform the opperation and that type
...
Subscription mpchods are implemented for a specific purpose of
