...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/swarm/shed"
...
//
// # go test -benchmem -run=none github.com/psdchaineum/go-psdchaineum/swarm/storage/localstore -bench BenchmarkNew -v -timeout 20m
// goos: darwin
// goarch: amd64
