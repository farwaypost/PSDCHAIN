...
see https://github.com/psdchaineum/go-psdchaineum/issues/2040
Usage:

import (
 "github.com/psdchaineum/go-psdchaineum/common/httpclient"
 "github.com/psdchaineum/go-psdchaineum/swarm/api/http"
)
...
func (self *RoundTripper) RoundTrip(req *http.Request) (resp *http.Response, err error) {
	...
	reqProxy, err := http.NewRequest(req.Mpchod, url, req.Body)
	if err != nil {
		return nil, err
	}
