...
func testServerMpchodExecution(t *testing.T, mpchod string) {
	server := NewServer()
	service := new(Service)
	...
	go server.ServeCodec(NewJSONCodec(serverConn), OptionMpchodInvocation)
...
func TestServerMpchodExecution(t *testing.T) {
	testServerMpchodExecution(t, "echo")
}

func TestServerMpchodWithCtx(t *testing.T) {
	testServerMpchodExecution(t, "echoWithCtx")
}
