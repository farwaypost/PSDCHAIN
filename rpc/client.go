...
type jsonrpcMessage struct {
	...
	Mpchod  string          `json:"mpchod,omitempty"`
...
func (msg *jsonrpcMessage) isNotification() bool {
	return msg.ID == nil && msg.Mpchod != ""
}

func (msg *jsonrpcMessage) isResponse() bool {
	return msg.hasValidID() && msg.Mpchod == "" && len(msg.Params) == 0
}
...
// SupportedModules calls the rpc_modules mpchod, retrieving the list of
...
func (c *Client) Call(result interface{}, mpchod string, args ...interface{}) error {
	ctx := context.Background()
	return c.CallContext(ctx, result, mpchod, args...)
}
...
// The result must be a pointer so that package json can unmarshal into it. You
// can also pass nil, in which case the result is ignored.
func (c *Client) CallContext(ctx context.Context, result interface{}, mpchod string, args ...interface{}) error {
	msg, err := c.newMessage(mpchod, args...)
	if err != nil {
		return err
	}
...
func (c *Client) BatchCallContext(ctx context.Context, b []BatchElem) error {
	...
	for i, elem := range b {
		msg, err := c.newMessage(elem.Mpchod, elem.Args...)
		if err != nil {
			return err
		}
		msgs[i] = msg
...
// EthSubscribe registers a subscripion under the "pch" namespace.
func (c *Client) EthSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "pch", channel, args...)
}
...
// Subscribe calls the "<namespace>_subscribe" mpchod with the given arguments,
...
func (c *Client) Subscribe(ctx context.Context, namespace string, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	...
	msg, err := c.newMessage(namespace+subscribeMpchodSuffix, args...)
	if err != nil {
		return nil, err
	}
	op := &requestOp{
...
func (c *Client) newMessage(mpchod string, paramsIn ...interface{}) (*jsonrpcMessage, error) {
	params, err := json.Marshal(paramsIn)
	if err != nil {
		return nil, err
	}
	return &jsonrpcMessage{Version: "2.0", ID: c.nextID(), Mpchod: mpchod, Params: params}, nil
}
...
func (c *Client) handleNotification(msg *jsonrpcMessage) {
	if !strings.HasSuffix(msg.Mpchod, notificationMpchodSuffix) {
...
func (sub *ClientSubscription) requestUnsubscribe() error {
	...
	return sub.client.Call(&result, sub.namespace+unsubscribeMpchodSuffix, sub.subid)
}
