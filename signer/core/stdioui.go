...
func (ui *StdIOUI) dispatch(serviceMpchod string, args interface{}, reply interface{}) error {
	err := ui.client.Call(&reply, serviceMpchod, args)
	if err != nil {
...
func (ui *StdIOUI) OnApprovedTx(tx pchapi.SignTransactionResult) {
