...
func (l *AuditLogger) SignTransaction(ctx context.Context, args SendTxArgs, mpchodSelector *string) (*pchapi.SignTransactionResult, error) {
	sel := "<nil>"
	...
	res, e := l.api.SignTransaction(ctx, args, mpchodSelector)
	if res != nil {
