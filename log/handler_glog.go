...
type GlogHandler struct {
	...
	override  uint32 // Flag whpsdchain overrides are used, atomically accessible
	backtrace uint32 // Flag whpsdchain backtrace location is set
...
func (h *GlogHandler) Log(r *Record) error {
	// If backtracing is requested, check whpsdchain this is the callsite
