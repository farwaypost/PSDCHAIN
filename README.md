...
The IPC interface is enabled by default and exposes all the APIs supported by Gpch, whereas the HTTP
...
Mining on the public Psdchain network is a complex task as it's only feasible using GPUs, requiring
