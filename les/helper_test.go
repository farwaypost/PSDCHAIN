...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/les/flowcontrol"
...
func testIndexers(db pchdb.Database, odr light.OdrBackend, iConfig *light.IndexerConfig) (*core.ChainIndexer, *core.ChainIndexer, *core.ChainIndexer) {
	chtIndexer := light.NewChtIndexer(db, odr, iConfig.ChtSize, iConfig.ChtConfirms)
	bloomIndexer := pch.NewBloomIndexer(db, iConfig.BloomSize, iConfig.BloomConfirms)
...
func newTestProtocolManager(lightSync bool, blocks int, generator func(int, *core.BlockGen), odr *LesOdr, peers *peerSet, db pchdb.Database) (*ProtocolManager, error) {
	var (
	...
	if lightSync {
		...
		gchain, _ := core.GenerateChain(gspec.Config, genesis, pchash.NewFaker(), db, blocks, generator)
...
// fails the test.
func newTestProtocolManagerMust(t *testing.T, lightSync bool, blocks int, generator func(int, *core.BlockGen), odr *LesOdr, peers *peerSet, db pchdb.Database) *ProtocolManager {
...
func newClientServerEnv(t *testing.T, blocks int, protocol int, waitIndexers func(*core.ChainIndexer, *core.ChainIndexer, *core.ChainIndexer), newPeer bool) (*TestEntity, *TestEntity, func()) {
	db, ldb := pchdb.NewMemDatabase(), pchdb.NewMemDatabase()
