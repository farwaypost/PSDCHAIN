...
// Fuzz implements a go-fuzz fuzzer mpchod to test various encoding mpchod
// invocations.
...
// fuzzEncode implements a go-fuzz fuzzer mpchod to test the bitset encoding and
// decoding algorithm.
...
// fuzzDecode implements a go-fuzz fuzzer mpchod to test the bit decoding and
