...
// Address represents the 20 byte address of an Psdchain account.
...
// IsHexAddress verifies whpsdchain a string can represent a valid hex-encoded
// Psdchain address or not.
