...
nested arrays of binary data, and RLP is the main encoding mpchod used
to serialize objects in Psdchain. The only purpose of RLP is to encode
structure; encoding specific atomic data types (eg. strings, ints,
floats) is left up to higher-order protocols; in Psdchain integers
