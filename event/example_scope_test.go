...
// The app's SubscribeResults mpchod starts sending calculation results to the given
// channel. Subscriptions created through this mpchod are tied to the lifetime of the App
