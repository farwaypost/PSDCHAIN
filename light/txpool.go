...
// to the PCH network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whpsdchain a transaction is valid according to the consensus rules.
