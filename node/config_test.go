...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gpch.ipc", false, filepath.Join(os.TempDir(), "gpch.ipc")},
		{"data", "gpch.ipc", false, "data/gpch.ipc"},
		{"data", "./gpch.ipc", false, "./gpch.ipc"},
		{"data", "/gpch.ipc", false, "/gpch.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gpch.ipc", true, `\\.\pipe\gpch.ipc`},
		{"data", "gpch.ipc", true, `\\.\pipe\gpch.ipc`},
		{"data", `\\.\pipe\gpch.ipc`, true, `\\.\pipe\gpch.ipc`},
	}
