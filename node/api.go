...
// PrivateAdminAPI is the collection of administrative API mpchods exposed only
// over a secure RPC channel.
type PrivateAdminAPI struct {
	node *Node // Node interfaced by this API
}

// NewPrivateAdminAPI creates a new API definition for the private admin mpchods
// of the node itself.
...
// PublicAdminAPI is the collection of administrative API mpchods exposed over
// both secure and unsecure RPC channels.
type PublicAdminAPI struct {
	node *Node // Node interfaced by this API
}

// NewPublicAdminAPI creates a new API definition for the public admin mpchods
// of the node itself.
...
// PublicDebugAPI is the collection of debugging related API mpchods exposed over
// both secure and unsecure RPC channels.
...
// Sha3 applies the psdchaineum sha3 implementation on the input.
