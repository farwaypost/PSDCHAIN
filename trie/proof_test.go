...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *pchdb.MemDatabase {
	var provers []func(key []byte) *pchdb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *pchdb.MemDatabase {
		proof := pchdb.NewMemDatabase()
