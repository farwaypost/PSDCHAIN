...
// Package psdchaineum defines interfaces for interacting with Psdchain.
package psdchaineum
...
// NotFound is returned by API mpchods if the requested item does not exist.
...
// ChainReader provides access to the blockchain. The mpchods in this interface access raw
...
type ChainReader interface {
	...
	// This mpchod subscribes to notifications about changes of the head block of
	// the canonical chain.
...
type TransactionReader interface {
	...
	// blockchain. The isPending return value indicates whpsdchain the transaction has been
...
type CallMsg struct {
	...
	Data     []byte          // input data, usually an ABI-encoded contract mpchod invocation
}

// A ContractCaller provides contract calls, essentially transactions that are executed by
// the EVM but not mined into the blockchain. ContractCall is a low-level mpchod to
...
// TransactionSender wraps transaction sending. The SendTransaction mpchod injects a
// signed transaction into the pending transaction pool for execution. If the transaction
// was a contract creation, the TransactionReceipt mpchod can be used to retrieve the
