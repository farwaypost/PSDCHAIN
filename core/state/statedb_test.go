...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := pchdb.NewMemDatabase()
	finalDb := pchdb.NewMemDatabase()
...
// https://github.com/psdchaineum/go-psdchaineum/pull/15549.
func TestCopy(t *testing.T) {
	// Create a random state test to copy and modify "independently"
	orig, _ := New(common.Hash{}, NewDatabase(pchdb.NewMemDatabase()))
...
// accessor mpchods on the reverted state must match the return value of the equivalent
// mpchods on the replayed state.
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(pchdb.NewMemDatabase()))
...
// checkEqual checks that mpchods of state and checkstate return the same values.
...
// See https://github.com/psdchaineum/go-psdchaineum/pull/15225#issuecomment-380191512
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(pchdb.NewMemDatabase()))
