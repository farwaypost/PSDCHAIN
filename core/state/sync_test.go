...
func makeTestState() (Database, common.Hash, []*testAccount) {
	...
	db := NewDatabase(pchdb.NewMemDatabase())
...
// account array.
func checkStateAccounts(t *testing.T, db pchdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db pchdb.Database, root common.Hash) error {
...
func checkStateConsistency(db pchdb.Database, root common.Hash) error {
...
func TestEmptyStateSync(t *testing.T) {
	...
	if req := NewStateSync(empty, pchdb.NewMemDatabase()).Missing(1); len(req) != 0 {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(pchdb.Database), srcRoot)
