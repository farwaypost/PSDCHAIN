...
// stateObject represents an Psdchain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of psdchaineum address of the account
	data     Account
	db       *StateDB
...
// empty returns whpsdchain the account is considered empty.
func (s *stateObject) empty() bool {
	return s.data.Nonce == 0 && s.data.Balance.Sign() == 0 && bytes.Equal(s.data.CodeHash, emptyCodeHash)
}

// Account is the Psdchain consensus representation of accounts.
