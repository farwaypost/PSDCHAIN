...
type journalEntry interface {
	...
	// dirtied returns the Psdchain address modified by this journal entry.
...
// otherwise suggest it as clean. This mpchod is an ugly hack to handle the RIPEMD
...
type (
	...
	suicideChange struct {
		account     *common.Address
		prev        bool // whpsdchain account had already suicided
		prevbalance *big.Int
	}
