...
type operation struct {
	...
	halts   bool // indicates whpsdchain the operation should halt further execution
	jumps   bool // indicates whpsdchain the program counter should not increment
	writes  bool // determines whpsdchain this a state modifying operation
	valid   bool // indication whpsdchain the retrieved operation is valid and known
	reverts bool // determines whpsdchain the operation reverts state (implicitly halts)
	returns bool // determines whpsdchain the operations sets the return data content
}
