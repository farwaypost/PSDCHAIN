...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/crypto/bn256"
	"github.com/psdchaineum/go-psdchaineum/params"
	"golang.org/x/crypto/ripemd160"
)

// PrecompiledContract is the basic interface for native Go contracts. The implementation
// requires a deterministic gas count based on the input size of the Run mpchod of the
// contract.
...
// PrecompiledContractsHomestead contains the default set of pre-compiled Psdchain
...
// PrecompiledContractsByzantium contains the default set of pre-compiled Psdchain
...
//
// This mpchod does not require any overflow checking as the input size gas costs
