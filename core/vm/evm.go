...
type Context struct {
	// CanTransfer returns whpsdchain the account contains
	// sufficient psdchain to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers psdchain from one account to the other
...
// EVM is the Psdchain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) psdchaineum virtual machine
...
func (evm *EVM) create(caller ContractRef, codeAndHash *codeAndHash, gas uint64, value *big.Int, address common.Address) ([]byte, common.Address, uint64, error) {
	...
	// check whpsdchain the max code size has been exceeded
