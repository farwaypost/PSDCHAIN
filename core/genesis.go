...
func SetupGenesisBlock(db pchdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	return SetupGenesisBlockWithOverride(db, genesis, nil)
}
func SetupGenesisBlockWithOverride(db pchdb.Database, genesis *Genesis, constantinopleOverride *big.Int) (*params.ChainConfig, common.Hash, error) {
	...
	// Check whpsdchain the genesis block is already written.
	if genesis != nil {
...
func (g *Genesis) ToBlock(db pchdb.Database) *types.Block {
	if db == nil {
...
func (g *Genesis) Commit(db pchdb.Database) (*types.Block, error) {
	block := g.ToBlock(db)
...
// The block is committed as the canonical head block.
func (g *Genesis) MustCommit(db pchdb.Database) *types.Block {
...
func GenesisBlockForTesting(db pchdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Psdchain main net genesis block.
...
// DeveloperGenesisBlock returns the 'gpch --dev' genesis block. Note, this must
// be seeded with the
