...
func newTestLDB() (*pchdb.LDBDatabase, func()) {
	dirname, err := ioutil.TempDir(os.TempDir(), "pchdb_test_")
	if err != nil {
		panic("failed to create test file: " + err.Error())
	}
	db, err := pchdb.NewLDBDatabase(dirname, 0, 0)
	if err != nil {
...
func TestMemoryDB_PutGet(t *testing.T) {
	testPutGet(pchdb.NewMemDatabase(), t)
}

func testPutGet(db pchdb.Database, t *testing.T) {
	t.Parallel()
...
func TestMemoryDB_ParallelPutGet(t *testing.T) {
	testParallelPutGet(pchdb.NewMemDatabase(), t)
}

func testParallelPutGet(db pchdb.Database, t *testing.T) {
	const n = 8
