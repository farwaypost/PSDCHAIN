...
// DeployFIFSRegistrar deploys a new Psdchain contract, binding an instance of FIFSRegistrar to it.
...
// FIFSRegistrar is an auto generated Go binding around an Psdchain contract.
...
// FIFSRegistrarCaller is an auto generated read-only Go binding around an Psdchain contract.
type FIFSRegistrarCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarTransactor is an auto generated write-only Go binding around an Psdchain contract.
type FIFSRegistrarTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarFilterer is an auto generated log filtering Go binding around an Psdchain contract events.
type FIFSRegistrarFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarSession is an auto generated Go binding around an Psdchain contract,
...
// FIFSRegistrarCallerSession is an auto generated read-only Go binding around an Psdchain contract,
...
// FIFSRegistrarTransactorSession is an auto generated write-only Go binding around an Psdchain contract,
...
// FIFSRegistrarRaw is an auto generated low-level Go binding around an Psdchain contract.
type FIFSRegistrarRaw struct {
	Contract *FIFSRegistrar // Generic contract binding to access the raw mpchods on
}

// FIFSRegistrarCallerRaw is an auto generated low-level read-only Go binding around an Psdchain contract.
type FIFSRegistrarCallerRaw struct {
	Contract *FIFSRegistrarCaller // Generic read-only contract binding to access the raw mpchods on
}

// FIFSRegistrarTransactorRaw is an auto generated low-level write-only Go binding around an Psdchain contract.
type FIFSRegistrarTransactorRaw struct {
	Contract *FIFSRegistrarTransactor // Generic write-only contract binding to access the raw mpchods on
}
...
// returns.
func (_FIFSRegistrar *FIFSRegistrarRaw) Call(opts *bind.CallOpts, result interface{}, mpchod string, params ...interface{}) error {
	return _FIFSRegistrar.Contract.FIFSRegistrarCaller.contract.Call(opts, result, mpchod, params...)
}
...
func (_FIFSRegistrar *FIFSRegistrarRaw) Transact(opts *bind.TransactOpts, mpchod string, params ...interface{}) (*types.Transaction, error) {
	return _FIFSRegistrar.Contract.FIFSRegistrarTransactor.contract.Transact(opts, mpchod, params...)
}
...
// returns, a slice of interfaces for anonymous returns and a struct for named
// returns.
func (_FIFSRegistrar *FIFSRegistrarCallerRaw) Call(opts *bind.CallOpts, result interface{}, mpchod string, params ...interface{}) error {
	return _FIFSRegistrar.Contract.contract.Call(opts, result, mpchod, params...)
}
...
// Transact invokes the (paid) contract mpchod with params as input values.
func (_FIFSRegistrar *FIFSRegistrarTransactorRaw) Transact(opts *bind.TransactOpts, mpchod string, params ...interface{}) (*types.Transaction, error) {
	return _FIFSRegistrar.Contract.contract.Transact(opts, mpchod, params...)
}

// Register is a paid mutator transaction binding the contract mpchod 0xd22057a9.
//
