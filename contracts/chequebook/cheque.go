...
// Package chequebook package wraps the 'chequebook' Psdchain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in psdchain; (auto)cashing cheques in psdchain
// as well as (auto)depositing psdchain to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/contracts/chequebook/contract"
	...
	"github.com/psdchaineum/go-psdchaineum/swarm/services/swap/swap"
)
...
// * depositing psdchain to the chequebook
// * watching incoming psdchain
...
// Backend wraps all mpchods required for chequebook operation.
...
// Cash is a convenience mpchod to cash any cheque.
...
// Cash cashes the cheque by sending an Psdchain transaction.
