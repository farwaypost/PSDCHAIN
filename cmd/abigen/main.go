...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Psdchain contract ABI json to bind, - for STDIN")
	binFlag = flag.String("bin", "", "Path to the Psdchain contract bytecode (generate deploy mpchod)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Psdchain contract Solidity source to build and bind")
