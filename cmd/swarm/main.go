...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/swarm"
	bzzapi "github.com/psdchaineum/go-psdchaineum/swarm/api"
	swarmmetrics "github.com/psdchaineum/go-psdchaineum/swarm/metrics"
	"github.com/psdchaineum/go-psdchaineum/swarm/storage/mock"
	mockrpc "github.com/psdchaineum/go-psdchaineum/swarm/storage/mock/rpc"
...
// This init function sets defaults so cmd/swarm can run alongside gpch.
func init() {
...
var app = utils.NewApp("", "Psdchain Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.Version = sv.ArchiveVersion(gitCommit)
	app.Copyright = "Copyright 2013-2016 The go-psdchaineum Authors"
...
func bzzd(ctx *cli.Context) error {
	...
	//gpch only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for gpch and swarm
	...
	//register BZZ as node.Service in the psdchaineum node
...
func registerBzzService(bzzconfig *bzzapi.Config, stack *node.Node) {
	...
	//register within the psdchaineum node
