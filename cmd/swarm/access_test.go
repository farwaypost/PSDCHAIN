...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/crypto/ecies"
	"github.com/psdchaineum/go-psdchaineum/log"
	"github.com/psdchaineum/go-psdchaineum/swarm/api"
	swarmapi "github.com/psdchaineum/go-psdchaineum/swarm/api/client"
...
func testPassword(t *testing.T) {
	...
	if authHeader == "" {
		t.Fatal("should be sompching here")
	}
...
// the specs at https://github.com/psdchainsphere/swarm-docs/blob/eb857afda906c6e7bb90d37f3f334ccce5eef230/act.md
