...
* Add `OnInputRequired(info UserInputRequest)` to internal API. This mpchod is used when Clef needs user input, e.g. passwords.
...
* Add `OnStartup` mpchod, to provide the UI with information about what API version
