Name "gpch ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/psdchaineum/go-psdchaineum/issues"
!define UPDATEURL "https://github.com/psdchaineum/go-psdchaineum/releases"
!define ABOUTURL "https://github.com/psdchaineum/go-psdchaineum#psdchaineum-go"
...
# Install gpch binary
Section "Gpch" GPCH_IDX
  SetOutPath $INSTDIR
  file {{.Gpch}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gpch.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gpch.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Gpch incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gpch.exe" "" "" "Psdchain" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gpch outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gpch.exe" "" "" "Psdchain" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gpch UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gpch.exe" "" "" "Psdchain" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/psdchaineum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "PSDCHAIN_SOCKET" "R" "HKLM" "\\.\pipe\gpch.ipc"
  ${EnvVarUpdate} $0 "PSDCHAIN_SOCKET" "A" "HKLM" "\\.\pipe\gpch.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GPCH_IDX}
    SectionGetSize ${GPCH_IDX} $0
