...
Please review the resulting diff to check whpsdchain the correct
...
var (
	...
	authorsFileHeader = "# This is the official list of go-psdchaineum authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-psdchaineum Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-psdchaineum"
	}
	if startOfSentence {
		return "The go-psdchaineum library"
	}
	return "the go-psdchaineum library"
}
