...
# 1. install gpch for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gpch
# 5. create gpch, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable PSDCHAIN_SOCKET
...
!define GROUPNAME "Psdchain"
!define APPNAME "Gpch"
!define DESCRIPTION "Official Go implementation of the Psdchain protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gpch is installed global
