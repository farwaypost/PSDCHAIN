...
// Package tests implements execution of Psdchain JSON tests.
package tests
...
/* See https://github.com/psdchaineum/tests/wiki/Blockchain-Tests-II

   Whpsdchain a block is valid or not is a bit subtle, it's defined by presence of
