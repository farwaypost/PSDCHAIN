...
// See https://github.com/psdchaineum/EIPs/issues/176 for the test format specification.
...
func (t *StateTest) Run(subtest StateSubtest, vmconfig vm.Config) (*state.StateDB, error) {
	...
	statedb := MakePreState(pchdb.NewMemDatabase(), t.json.Pre)
...
func MakePreState(db pchdb.Database, accounts core.GenesisAlloc) *state.StateDB {
...
func (tx *stTransaction) toMessage(ps stPostState) (core.Message, error) {
	...
	// Value, Data hex encoding is messy: https://github.com/psdchaineum/tests/issues/203
	value := new(big.Int)
	if valueHex != "0x" {
