...
// Contains a wrapper for the Psdchain client.
...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/pchclient"
)

// PsdchainClient provides access to the Psdchain APIs.
type PsdchainClient struct {
	client *pchclient.Client
}

// NewPsdchainClient connects a client to the given URL.
func NewPsdchainClient(rawurl string) (client *PsdchainClient, _ error) {
	rawClient, err := pchclient.Dial(rawurl)
	return &PsdchainClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *PsdchainClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *PsdchainClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *PsdchainClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *PsdchainClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *PsdchainClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *PsdchainClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *PsdchainClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *PsdchainClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *PsdchainClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *PsdchainClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *PsdchainClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *PsdchainClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *PsdchainClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *PsdchainClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *PsdchainClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *PsdchainClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *PsdchainClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *PsdchainClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *PsdchainClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *PsdchainClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *PsdchainClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *PsdchainClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *PsdchainClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *PsdchainClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *PsdchainClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *PsdchainClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
//
// If the transaction was a contract creation use the TransactionReceipt mpchod to get the
// contract address after the transaction has been mined.
func (ec *PsdchainClient) SendTransaction(ctx *Context, tx *Transaction) error {
