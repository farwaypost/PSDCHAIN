...
var (
	...
	pchashChainConfig *params.ChainConfig
...
func init() {
	...
	pchashChainConfig = params.TestChainConfig
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, blocks int) (*worker, *testWorkerBackend) {
	...
	w.setPsdchainbase(testBankAddress)
	return w, backend
}

func TestPendingStateAndBlockEthash(t *testing.T) {
	testPendingStateAndBlock(t, pchashChainConfig, pchash.NewFaker())
}
func TestPendingStateAndBlockClique(t *testing.T) {
	testPendingStateAndBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, pchdb.NewMemDatabase()))
}
...
func TestEmptyWorkEthash(t *testing.T) {
	testEmptyWork(t, pchashChainConfig, pchash.NewFaker())
}
func TestEmptyWorkClique(t *testing.T) {
	testEmptyWork(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, pchdb.NewMemDatabase()))
}
...
func TestStreamUncleBlock(t *testing.T) {
	pchash := pchash.NewFaker()
	defer pchash.Close()

	w, b := newTestWorker(t, pchashChainConfig, pchash, 1)
	defer w.close()
...
func TestRegenerateMiningBlockEthash(t *testing.T) {
	testRegenerateMiningBlock(t, pchashChainConfig, pchash.NewFaker())
}

func TestRegenerateMiningBlockClique(t *testing.T) {
	testRegenerateMiningBlock(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, pchdb.NewMemDatabase()))
}
...
func TestAdjustIntervalEthash(t *testing.T) {
	testAdjustInterval(t, pchashChainConfig, pchash.NewFaker())
}

func TestAdjustIntervalClique(t *testing.T) {
	testAdjustInterval(t, cliqueChainConfig, clique.New(cliqueChainConfig.Clique, pchdb.NewMemDatabase()))
}
