...
// Package p2p implements the Psdchain p2p network protocols.
package p2p
...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/p2p/discover"
	"github.com/psdchaineum/go-psdchaineum/p2p/discv5"
	"github.com/psdchaineum/go-psdchaineum/p2p/enode"
	"github.com/psdchaineum/go-psdchaineum/p2p/enr"
...
type Config struct {
	...
	// DiscoveryV5 specifies whpsdchain the new topic-discovery based V5 discovery
...
func (srv *Server) setupDiscovery() error {
	...
	if srv.NAT != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(srv.NAT, srv.quit, "udp", realaddr.Port, realaddr.Port, "psdchaineum discovery")
		}
	}
...
func (srv *Server) setupListening() error {
	...
	if !laddr.IP.IsLoopback() && srv.NAT != nil {
		srv.loopWG.Add(1)
		go func() {
			nat.Map(srv.NAT, srv.quit, "tcp", laddr.Port, laddr.Port, "psdchaineum p2p")
			srv.loopWG.Done()
		}()
	}
	return nil
...
type NodeInfo struct {
	...
	ENR   string `json:"enr"`   // Psdchain Node Record
