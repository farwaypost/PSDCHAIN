...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/p2p/simulations/pipes"
...
func (sn *SimNode) ServeRPC(conn net.Conn) error {
	...
	handler.ServeCodec(rpc.NewJSONCodec(conn), rpc.OptionMpchodInvocation|rpc.OptionSubscriptions)
	return nil
}

// Snapshots creates snapshots of the services by calling the
// simulation_snapshot RPC mpchod
