...
type Interface interface {
	// These mpchods manage a mapping between a port on the local
	...
	// This mpchod should return the external (Internet-facing)
	// address of the gateway device.
	ExternalIP() (net.IP, error)

	// Should return name of the mpchod. This is used for logging.
	String() string
}
...
func Any() Interface {
	// TODO: attempt to discover whpsdchain the local machine has an
...
// auto-discovered. Calls to the Interface mpchods on this type will
// wait until the discovery is done and then call the mpchod on the
