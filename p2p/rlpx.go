...
import (
	...
	"github.com/psdchaineum/go-psdchaineum/crypto/secp256k1"
...
// and also verifies whpsdchain the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whpsdchain read packet had plain format.
