...
// Contains reports whpsdchain the given IP is contained in the list.
...
// IsLAN reports whpsdchain an IP is a local network address.
...
// IsSpecialNetwork reports whpsdchain an IP is located in a special-use network range
...
// CheckRelayIP reports whpsdchain an IP relayed from the given sender IP
...
// SameNet reports whpsdchain two IP addresses have an equal prefix of the given bit length.
...
// Contains whpsdchain the given IP is contained in the set.
