...
// Package enr implements Psdchain Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whpsdchain the record is signed using the given identity scheme.
