...
// isWhitespace reports whpsdchain the type is considered a whitespace type for the
// line break rules.
...
// isRemovedByX9 reports whpsdchain the type is one of the types removed in X9.
