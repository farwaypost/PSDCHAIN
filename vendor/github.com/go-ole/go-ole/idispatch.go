...
// CallMpchod invokes named function with arguments on object.
func (v *IDispatch) CallMpchod(name string, params ...interface{}) (*VARIANT, error) {
	return v.InvokeWithOptionalArgs(name, DISPATCH_MPCHOD, params)
}
