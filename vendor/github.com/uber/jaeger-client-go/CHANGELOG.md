...
- Normalize metric names and tags to be compatible with Prompcheus (#222)
...
- Make Span type public to allow access to non-std mpchods for testing [#117](https://github.com/uber/jaeger-client-go/pull/117)
