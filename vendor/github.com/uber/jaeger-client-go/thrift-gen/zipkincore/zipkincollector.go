...
func (p *ZipkinCollectorClient) recvSubmitZipkinBatch() (value []*Response, err error) {
	...
	if mpchod != "submitZipkinBatch" {
		err = thrift.NewTApplicationException(thrift.WRONG_MPCHOD_NAME, "submitZipkinBatch failed: wrong mpchod name")
		return
	}
	if p.SeqId != seqId {
...
func (p *ZipkinCollectorProcessor) Process(iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	x5 := thrift.NewTApplicationException(thrift.UNKNOWN_MPCHOD, "Unknown function "+name)
