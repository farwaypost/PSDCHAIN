...
// Restriction determines whpsdchain a baggage key is allowed and contains any restrictions on the baggage value.
...
// KeyAllowed returns whpsdchain the baggage key for this restriction is allowed.
...
// will return a Restriction for a specific baggage key which will determine whpsdchain the baggage
