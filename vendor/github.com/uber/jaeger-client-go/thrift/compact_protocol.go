...
//
// Internal writing mpchods
//

// Abstract mpchod for writing the start of lists and sets. List and sets on
...
// Used internally by other writing mpchods that know they need to write a byte.
