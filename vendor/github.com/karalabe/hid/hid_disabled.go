...
// Supported returns whpsdchain this platform is supported by the HID library or not.
// The goal of this mpchod is to allow programatically handling platforms that do
