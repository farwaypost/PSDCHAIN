...
// Is this mpchod side-effect-free (or safe in HTTP parlance), or idempotent,
// or neither? HTTP based RPC implementation may choose GET verb for safe
// mpchods, and PUT verb for idempotent mpchods instead of the default POST.
type MpchodOptions_IdempotencyLevel int32

const (
	MpchodOptions_IDEMPOTENCY_UNKNOWN MpchodOptions_IdempotencyLevel = 0
	MpchodOptions_NO_SIDE_EFFECTS     MpchodOptions_IdempotencyLevel = 1
	MpchodOptions_IDEMPOTENT          MpchodOptions_IdempotencyLevel = 2
)

var MpchodOptions_IdempotencyLevel_name = map[int32]string{
	0: "IDEMPOTENCY_UNKNOWN",
	1: "NO_SIDE_EFFECTS",
	2: "IDEMPOTENT",
}
var MpchodOptions_IdempotencyLevel_value = map[string]int32{
	"IDEMPOTENCY_UNKNOWN": 0,
	"NO_SIDE_EFFECTS":     1,
	"IDEMPOTENT":          2,
}

func (x MpchodOptions_IdempotencyLevel) Enum() *MpchodOptions_IdempotencyLevel {
	p := new(MpchodOptions_IdempotencyLevel)
	*p = x
	return p
}
func (x MpchodOptions_IdempotencyLevel) String() string {
	return proto.EnumName(MpchodOptions_IdempotencyLevel_name, int32(x))
}
func (x *MpchodOptions_IdempotencyLevel) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(MpchodOptions_IdempotencyLevel_value, data, "MpchodOptions_IdempotencyLevel")
	if err != nil {
		return err
	}
	*x = MpchodOptions_IdempotencyLevel(value)
	return nil
}
func (MpchodOptions_IdempotencyLevel) EnumDescriptor() ([]byte, []int) {
...
type ServiceDescriptorProto struct {
	Name             *string                  `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	Mpchod           []*MpchodDescriptorProto `protobuf:"bytes,2,rep,name=mpchod" json:"mpchod,omitempty"`
...
func (m *ServiceDescriptorProto) GetMpchod() []*MpchodDescriptorProto {
	if m != nil {
		return m.Mpchod
	}
	return nil
...
// Describes a mpchod of a service.
type MpchodDescriptorProto struct {
	Name *string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`
	// Input and output type names.  These are resolved in the same way as
	// FieldDescriptorProto.type_name, but must refer to a message type.
	InputType  *string        `protobuf:"bytes,2,opt,name=input_type,json=inputType" json:"input_type,omitempty"`
	OutputType *string        `protobuf:"bytes,3,opt,name=output_type,json=outputType" json:"output_type,omitempty"`
	Options    *MpchodOptions `protobuf:"bytes,4,opt,name=options" json:"options,omitempty"`
...
func (m *MpchodDescriptorProto) Reset()                    { *m = MpchodDescriptorProto{} }
func (m *MpchodDescriptorProto) String() string            { return proto.CompactTextString(m) }
func (*MpchodDescriptorProto) ProtoMessage()               {}
func (*MpchodDescriptorProto) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }

const Default_MpchodDescriptorProto_ClientStreaming bool = false
const Default_MpchodDescriptorProto_ServerStreaming bool = false

func (m *MpchodDescriptorProto) GetName() string {
	if m != nil && m.Name != nil {
		return *m.Name
	}
	return ""
...
func (m *MpchodDescriptorProto) GetInputType() string {
...
func (m *MpchodDescriptorProto) GetOutputType() string {
...
func (m *MpchodDescriptorProto) GetOptions() *MpchodOptions {
	if m != nil {
		return m.Options
	}
	return nil
...
func (m *MpchodDescriptorProto) GetClientStreaming() bool {
	if m != nil && m.ClientStreaming != nil {
		return *m.ClientStreaming
	}
	return Default_MpchodDescriptorProto_ClientStreaming
}

func (m *MpchodDescriptorProto) GetServerStreaming() bool {
	if m != nil && m.ServerStreaming != nil {
		return *m.ServerStreaming
	}
	return Default_MpchodDescriptorProto_ServerStreaming
}
...
type FileOptions struct {
	...
	// generated to contain the file's getDescriptor() mpchod as well as any
...
type MessageOptions struct {
	...
	// Whpsdchain the message is an automatically generated map entry type for the
	// maps field.
	//
	// For maps fields:
...
type FieldOptions struct {
	...
	//
	// This is only a hint.  Implementations are free to choose whpsdchain to use
	...
	// all mpchod signatures remain the same.  Furthermore, thread-safety of the
	// interface is not affected by this option; const mpchods remain safe to
	// call from multiple threads concurrently, while non-const mpchods continue
	...
	// check its required fields, regardless of whpsdchain or not the message has
	// been parsed.
...
type MpchodOptions struct {
	// Is this mpchod deprecated?
	// Depending on the target platform, this can emit Deprecated annotations
	// for the mpchod, or it will be completely ignored; in the very least,
	// this is a formalization for deprecating mpchods.
	Deprecated       *bool                           `protobuf:"varint,33,opt,name=deprecated,def=0" json:"deprecated,omitempty"`
	IdempotencyLevel *MpchodOptions_IdempotencyLevel `protobuf:"varint,34,opt,name=idempotency_level,json=idempotencyLevel,enum=google.protobuf.MpchodOptions_IdempotencyLevel,def=0" json:"idempotency_level,omitempty"`
	// The parser stores options it doesn't recognize here. See above.
	UninterpretedOption          []*UninterpretedOption `protobuf:"bytes,999,rep,name=uninterpreted_option,json=uninterpretedOption" json:"uninterpreted_option,omitempty"`
	proto.XXX_InternalExtensions `json:"-"`
	XXX_unrecognized             []byte `json:"-"`
...
func (m *MpchodOptions) Reset()                    { *m = MpchodOptions{} }
func (m *MpchodOptions) String() string            { return proto.CompactTextString(m) }
func (*MpchodOptions) ProtoMessage()               {}
func (*MpchodOptions) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{16} }

var extRange_MpchodOptions = []proto.ExtensionRange{
	{1000, 536870911},
}

func (*MpchodOptions) ExtensionRangeArray() []proto.ExtensionRange {
	return extRange_MpchodOptions
}

const Default_MpchodOptions_Deprecated bool = false
const Default_MpchodOptions_IdempotencyLevel MpchodOptions_IdempotencyLevel = MpchodOptions_IDEMPOTENCY_UNKNOWN

func (m *MpchodOptions) GetDeprecated() bool {
	if m != nil && m.Deprecated != nil {
		return *m.Deprecated
	}
	return Default_MpchodOptions_Deprecated
}

func (m *MpchodOptions) GetIdempotencyLevel() MpchodOptions_IdempotencyLevel {
	if m != nil && m.IdempotencyLevel != nil {
		return *m.IdempotencyLevel
	}
	return Default_MpchodOptions_IdempotencyLevel
}

func (m *MpchodOptions) GetUninterpretedOption() []*UninterpretedOption {
	if m != nil {
		return m.UninterpretedOption
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*MpchodDescriptorProto)(nil), "google.protobuf.MpchodDescriptorProto")
	...
	proto.RegisterType((*MpchodOptions)(nil), "google.protobuf.MpchodOptions")
	...
	proto.RegisterEnum("google.protobuf.MpchodOptions_IdempotencyLevel", MpchodOptions_IdempotencyLevel_name, MpchodOptions_IdempotencyLevel_value)
}
