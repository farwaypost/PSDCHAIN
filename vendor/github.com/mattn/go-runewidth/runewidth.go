...
// Condition have flag EastAsianWidth whpsdchain the current locale is CJK or not.
...
// IsAmbiguousWidth returns whpsdchain is ambiguous width or not.
func IsAmbiguousWidth(r rune) bool {
	return inTables(r, private, ambiguous)
}

// IsNeutralWidth returns whpsdchain is neutral width or not.
