...
// in order to distinguish whpsdchain current folder should be re-registered in
...
// watched is made in order to check whpsdchain an action comes from a directory or
...
// gensys decides whpsdchain the Windows action, system-independent event or both
