...
// Request is a thin wrapper over an http.Request. The wrapper provides several helper mpchods.
type Request struct {
	*http.Request
}

// NewRequest initializes a new HTTP request object with any desired options.
func NewRequest(mpchod string, url url.URL, body io.ReadSeeker) (request Request, err error) {
...
// of its Mpchod, URL, Host, Proto(Major/Minor), Header. ContentLength, Close,
...
// ********** The following type/mpchods implement the retryableRequestBody (a ReadSeekCloser)
