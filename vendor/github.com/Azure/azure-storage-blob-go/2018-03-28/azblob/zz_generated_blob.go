...
// blobClient is the client for the Blob mpchods of the Azblob service.
...
// rangeGetContentMD5 is when set to true and specified togpsdchain with the Range, the service returns the MD5 hash for
