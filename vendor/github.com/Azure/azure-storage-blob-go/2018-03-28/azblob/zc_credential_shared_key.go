...
type SharedKeyCredential struct {
	// Only the NewSharedKeyCredential mpchod should set these; all other mpchods should treat them as read-only
	accountName string
	accountKey  []byte
}
...
// credentialMarker is a package-internal mpchod that exists just to satisfy the Credential interface.
