...
type CorsRule struct {
	...
	// AllowedMpchods - The mpchods (HTTP request verbs) that the origin domain may use for a CORS request. (comma separated)
	AllowedMpchods string `xml:"AllowedMpchods"`
...
type Logging struct {
	...
	// Delete - Indicates whpsdchain all delete requests should be logged.
	Delete bool `xml:"Delete"`
	// Read - Indicates whpsdchain all read requests should be logged.
	Read bool `xml:"Read"`
	// Write - Indicates whpsdchain all write requests should be logged.
...
type Metrics struct {
	// Version - The version of Storage Analytics to configure.
	Version *string `xml:"Version"`
	// Enabled - Indicates whpsdchain metrics are enabled for the Blob service.
	Enabled bool `xml:"Enabled"`
	// IncludeAPIs - Indicates whpsdchain metrics should generate summary statistics for called API operations.
...
type RetentionPolicy struct {
	// Enabled - Indicates whpsdchain a retention policy is enabled for the storage service
	Enabled bool `xml:"Enabled"`
