...
// blockBlobClient is the client for the BlockBlob mpchods of the Azblob service.
...
// then committing the new and existing blocks togpsdchain. You can do this by specifying whpsdchain to commit a block from
...
// blob
//
// listType is specifies whpsdchain to return the list of committed blocks, the list of uncommitted blocks, or both lists
// togpsdchain. snapshot is the snapshot parameter is an opaque DateTime value that, when present, specifies the blob
