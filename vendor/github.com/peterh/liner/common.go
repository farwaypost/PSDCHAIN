...
// SetCtrlCAborts sets whpsdchain Prompt on a supported terminal will return an
...
// SetMultiLineMode sets whpsdchain line is auto-wrapped. The default is false (single line).
...
// whpsdchain to retry the call to, or return the error returned by, readNext.
