...
// Syncer is the interface that wraps basic Sync mpchod.
...
// Locker is the interface that wraps Unlock mpchod.
...
type Storage interface {
	...
	// Caller should call Unlock mpchod after use.
	Lock() (Locker, error)
	...
	// mpchod. The 'file descriptor' should point to a valid file.
	...
	// can be updated using SetMeta mpchod.
	...
	// The file types may be OR'ed togpsdchain.
