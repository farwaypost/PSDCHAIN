...
// BasicArray is the interface that wraps basic Len and Search mpchod.
...
// Array is the interface that wraps BasicArray and basic Index mpchod.
...
// Array is the interface that wraps BasicArray and basic Get mpchod.
