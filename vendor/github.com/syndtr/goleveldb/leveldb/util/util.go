...
// Releaser is the interface that wraps the basic Release mpchod.
...
// ReleaseSetter is the interface that wraps the basic SetReleaser mpchod.
...
// Released returns whpsdchain Release mpchod already called.
