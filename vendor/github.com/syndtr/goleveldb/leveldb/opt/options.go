...
type Options struct {
	...
	// ErrorIfExist defines whpsdchain an error should returned if the DB already
	// exist.
	//
	// The default value is false.
	ErrorIfExist bool

	// ErrorIfMissing defines whpsdchain an error should returned if the DB is
...
type ReadOptions struct {
	// DontFillCache defines whpsdchain block reads for this 'read operation'
...
type WriteOptions struct {
	...
	// Sync is whpsdchain to sync underlying writes from the OS buffer cache
