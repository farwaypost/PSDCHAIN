...
// See: http://duktape.org/api.html#duk_call_mpchod
func (d *Context) CallMpchod(nargs int) {
	C.duk_call_mpchod(d.duk_context, C.duk_idx_t(nargs))
}
...
// See: http://duktape.org/api.html#duk_pcall_mpchod
func (d *Context) PcallMpchod(nargs int) int {
	return int(C.duk_pcall_mpchod(d.duk_context, C.duk_idx_t(nargs)))
}
