...
There is a mpchod to inject timers to the global scope:
```go
package main
...
Pull requests are welcome! Also, if you want to discuss sompching send a pull request with proposal and changes.
