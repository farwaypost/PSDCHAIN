...
// already exists, regardless of whpsdchain O_EXCL was specified or not.
// To ensure this behavior, it normally sets OpenExclusive for all
// Create calls, regardless of whpsdchain the original call had it set.
...
// them to the FUSE server. Without this, writpchrough caching is
// used.
