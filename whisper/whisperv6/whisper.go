...
// Whisper represents a dark communication interface through the Psdchain
...
// New creates a Whisper client ready to communicate through the Psdchain P2P network.
...
// param isP2P indicates whpsdchain the message is peer-to-peer (should not be forwarded).
